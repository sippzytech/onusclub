    ...
    <div className="flex items-start gap-4">
      <div className="flex-1">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1 rounded-full bg-brand-gold/15 text-brand-green px-2 py-0.5 text-xs font-medium">
            ⭐ Premium · Active
          </span>
        </div>
        ...
        <button
          onClick={downgrade}
          className="text-xs text-brand-olive underline mt-2 hover:text-brand-green"
        >
      ...
      <button
        ...
        className={
          ...
          (enabled ? "bg-brand-green" : "bg-brand-olive/30")
        }
      >
        <span
          className={
